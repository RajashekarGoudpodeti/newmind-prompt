...
"""autogenerated by genpy from newmind_test/ImageAnalyzerActionFeedback.msg. Do not edit."""
import sys
...
class ImageAnalyzerActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "newmind_test/ImageAnalyzerActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','newmind_test/ImageAnalyzerFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ImageAnalyzerActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = newmind_test.msg.ImageAnalyzerFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = newmind_test.msg.ImageAnalyzerFeedback()
